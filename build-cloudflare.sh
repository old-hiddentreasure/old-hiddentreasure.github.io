...
# 2. 複製所有靜態網頁資源至部署資料夾下
cp style.css script.js hoian_cover.png bali_waterfront.png columns.html stock-learning.html sanctuary.html stock-books.html trading-vault.html stock-finger.html sanctuary.json sanctuary-teaching.json sanctuary-live.json sanctuary-finger.json stock-books.json stock_learning.png cloudflare-dist/
cp index.html cloudflare-dist/index.html
cp -f *.md cloudflare-dist/ 2>/dev/null || true
cp -f *.png *.jpg *.jpeg cloudflare-dist/ 2>/dev/null || true
