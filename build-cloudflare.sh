...
# 2. 複製所有靜態網頁資源至部署資料夾下
cp style.css script.js hoian_cover.png bali_waterfront.png columns.html stock-learning.html sanctuary.html stock-books.html trading-vault.html sanctuary.json sanctuary-teaching.json sanctuary-live.json stock-books.json stock_learning.png cloudflare-dist/
